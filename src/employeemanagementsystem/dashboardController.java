...
public class dashboardController implements Initializable {
    ...
    @FXML
    private TableColumn<employeeData, String> addEmployee_col_department;
    ...
    @FXML
    private Label salary_department;
    
    @FXML
    private TextField salary_salary;
    
    @FXML
    private Button salary_updBtn;
    ...
    @FXML
    private TableColumn<employeeData, String> salary_col_department;
    ...
    public void addEmployeeAdd() {
        ...
        String sql = "INSERT INTO employee "
                + "(employee_id,firstName,lastName,gender,phoneNum,position,department,image,date) "
                + "VALUES(?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                    ...
                    || addEmployee_department.getSelectionModel().getSelectedItem() == null
                ...
                if (result.next()) {
                    ...
                    prepare.setString(7, (String) addEmployee_department.getSelectionModel().getSelectedItem());
                    ...
                    String insertInfo = "insert into employee_info "
                            + "(employee_id,firstName,lastName,position,department,salary,date) "
                            + "values(?,?,?,?,?,?,?)";
                    ...
                    prepare.setString(5, (String) addEmployee_department.getSelectionModel().getSelectedItem());
    ...
    public void addEmployeeUpdate() {
        ...
        String sql = "Update employee SET firstName = '"
                ...
                + addEmployee_position.getSelectionModel().getSelectedItem() + "',department = '"
                + addEmployee_department.getSelectionModel().getSelectedItem() + "',image = '"
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    String updateInfo = "update employee_info set firstname ='"
                            ...
                            + addEmployee_position.getSelectionModel().getSelectedItem() + "',department='"
                            + addEmployee_department.getSelectionModel().getSelectedItem()
                            + "' WHERE employee_id = '"
                            + addEmployee_employeeID.getText() + "'";
    ...
    private String[] positionList = {"Junior Analyst", "Software Enginner", "Quality Analyst", "Senior Analyst", "Analyst", "President", "Developer", "Executive", "Senior Software Engineer", "Lead Associate", "Manager", "Vice President"};
    ...
    private String[] departmentList = {"Operations", "IT", "HR-Admin", "Buisness Administration"};
    ...
    public void addEmployeeDepartmentList() {
        ...
        addEmployee_department.setItems(listData);
    }
    ...
    public void salaryUpdate() {
        ...
        String sql = "update employee_info set salary = '"
        ...
        try {
            ...
            if (salary_employeeID.getText().isEmpty()
                    ...
                    || salary_department.getText().isEmpty()) {
                alert = new Alert(AlertType.ERROR);
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
    ...
    public void SalaryShowListData() {
        ...
        salary_col_department.setCellValueFactory(new PropertyValueFactory<>("department"));
    ...
    public void salarySelect() {
        ...
        salary_department.setText(employeeD.getDepartment());
